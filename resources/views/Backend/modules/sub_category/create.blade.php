            ...
            <div class="card m-4">
                ...
                <div class="card-body">
                    ...
                    <form class="form" method="POST" action="{{ route('sub-category.store') }}">
                        ...
                        <input name="name" id="name" type="text" placeholder="Sub Category Name" class="form-control"
                            value="{{ old('name') }}">

                        <label class="control-label" for="slug">Slug</label>
                        <input name="slug" id="slug" type="text" placeholder="Sub Category Slug" class="form-control"
                            value="{{ old('slug') }}">
